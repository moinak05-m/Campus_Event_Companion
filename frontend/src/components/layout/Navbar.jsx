    ...
    <>
      ...
      <div className="max-w-7xl mx-auto glass rounded-2xl px-6 py-3 flex items-center justify-between border-white/5">
        ...
        <div className="hidden md:flex items-center gap-8">
          ...
          <NavLink to="/explorer" label="Explore" />
          <NavLink to="/certificates" label="Vault" />
          <NavLink label="About" />
        </div>
      ...
      {isOpen && (
        ...
        >
          ...
          <NavLink to="/explorer" label="Explore" onClick={() => setIsOpen(false)} />
          <NavLink to="/certificates" label="Certificates" onClick={() => setIsOpen(false)} />
          <NavLink label="About" onClick={() => setIsOpen(false)} />
